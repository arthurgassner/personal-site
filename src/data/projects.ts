...
const data: Project[] = [
  ...
  },
  {
    ...
    date: '2022-03-26',
    desc: 'I had the chance to present biped.ai at the Applied Machine Learning Days (AMLD) in front of more than 2000 people, as part of a startup spotlight led by Innovaud.',
  },
  {
  ...
  {
    title:
      'Towards a Scalable Behaviour-Based Distributed Control Algorithm for Groups of Mobile Robots',
    subtitle: 'How to make wheeled-robots swarm better',
    link: '/pdfs/DIS.pdf',
    image: '/images/projects/DIS.png',
    date: '2020-01-01',
    desc: 'We developed effective distributed and reactive controllers for small groups of mobile robots with substantial hardware limitations.',
  },
  {
    ...
    date: '2020-01-01',
    desc: 'We assessed various machine learning methods to predict whether a stock was undervalued or overvalued following an IPO.',
  },
];
